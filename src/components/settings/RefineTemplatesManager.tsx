...
export function RefineTemplatesManager() {
  ...
  const [drafts, setDrafts] = useState<RefineTemplate[]>(refineTemplates);
          ...
          {drafts.map((t) => (
            ...
            >
              ...
              <span className="v-rtmpl__item-sub">
                {t.description?.trim() || t.systemPrompt.replace(/\s+/g, " ").trim().slice(0, 60)}
              </span>
            </button>
          ))}
        </div>
          ...
          <>
            ...
            <div className="v-rtmpl__form">
              ...
              <label className="v-rtmpl__field v-rtmpl__field--grow">
                <span className="v-rtmpl__label">System prompt</span>
                <textarea
